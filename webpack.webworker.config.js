...
module.exports = {
  ...
  "entry": {
    ...
    "webworker": [
      "./src/main.webworker.ts"
    ]
  },
  "output": {
    "path": path.join(process.cwd(), "dist/webworker"),
  ...
  "plugins": [
    ...
    new AngularCompilerPlugin({
      "mainPath": "main.webworker.ts",
      "entryModule": "app/app.webworker.module#AppWebWorkerModule",
      "platform": 0,
